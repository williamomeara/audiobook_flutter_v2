...
class TextNormalizer {
  ...
  ///
  /// The order matters:
  /// 1. Quotes first (simple replacements)
  /// 2. Dashes (includes em-dash with special spacing)
  /// 3. Ellipsis
  /// 4. Ligatures
  /// 5. Spaces (including zero-width removal)
  /// 6. Symbols
  /// 7. Whitespace cleanup (last, to fix any introduced issues)
